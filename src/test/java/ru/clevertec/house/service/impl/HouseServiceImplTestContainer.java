...
import static util.initdata.ConstantsForHouse.HOUSE_UUID_FOR_FIND;
...
public class HouseServiceImplTestContainer extends PostgresSqlContainerInitializer {
    ...
    class FindById {
        ...
        void shouldReturnExpectedHouseByUUID() {
            // given
            UUID houseUuid = HOUSE_UUID_FOR_FIND;

            Optional<House> houseInDB = HouseTestData.builder()
                    .withUuid(HOUSE_UUID_FOR_FIND)
                    .build()
                    .getOptionalEntity();
    ...
    class Update {
        ...
        void shouldReturnUpdatedHouseResponseIfValidHouseRequest() {
            ...
            House houseToUpdate = HouseTestData.builder()
                    .withArea(UPDATE_HOUSE_AREA)
                    .withCity(UPDATE_HOUSE_CITY)
                    .build()
                    .getEntity();
